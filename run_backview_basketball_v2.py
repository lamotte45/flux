...
a large shaved design MUST be present on the back of the head,
deeply carved into the fade, clearly visible,

circular shaved region with strong contrast,
within the circle are carved razor lines forming a basketball pattern,
including curved intersecting arcs and outer rib lines,

the design is bold, centered, and dominates the haircut,
...
image = pipe(
    ...
    guidance_scale=6.0,  # lowered for better compliance
    width=1024,
    height=1024
).images[0]
...
# SAVE
# -------------------------------
output_path = f"{OUTPUT_DIR}/backview_basketball_v2.png"
